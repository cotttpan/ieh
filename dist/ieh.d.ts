...
export declare type Reducer<K, V, T> = (acc: T, value: V, key: K, index: number, src: Entries<K, V>) => T;
...
export declare function reduce<K, V, T>(co: Entries<K, V>, callback: Reducer<K, V, T>, init: T): T;
